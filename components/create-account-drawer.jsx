...
<Drawer open={open} onOpenChange={setOpen} >
  ...
  <SelectContent>
    <SelectItem className="bg-white" value="CURRENT">Current</SelectItem>
    <SelectItem className="bg-white" value="SAVINGS">Savings</SelectItem>
  </SelectContent>
</Select>
          ...
          <div className='flex gap-4 pt-4'>
                ...
                <Button type="button" variant="outline" className="flex-1">
                  Cancel
                      ...
                      <Button type="submit" className="flex-1 bg-black text-white"  disabled={createAccountLoading}>
